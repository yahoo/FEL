...
public class TypeLanguageModel implements Serializable {
	...
	SimpleJSAP jsap = new SimpleJSAP( TypeLanguageModel.class.getName(), "Language model for types builder", new Parameter[] {
		new FlaggedOption( "input", JSAP.STRING_PARSER, JSAP.NO_DEFAULT, JSAP.REQUIRED, 'i', "input", "Input file" ),
		new FlaggedOption( "output", JSAP.STRING_PARSER, JSAP.NO_DEFAULT, JSAP.NOT_REQUIRED, 'o', "output", "File to serialize the data structure" ), } );
