...
public class QuasiSuccinctEntityHash extends AbstractEntityHash implements Serializable {
    ...
    public QuasiSuccinctEntityHash( Object2LongFunction<? extends CharSequence> hash, EliasFanoMonotoneLongBigList[] pointers, EliasFanoLongBigList[] values,
    ...
    /**
     * Creates a QuasiSuccinctEntityHash from a datapack file. This class will compress everything: strings using minimal perfect hash functions, entity identifiers, and all the entity features, provided tha
	...
	for ( StringAndCandidate sc : stringAndCandidates ) {
		...
		//        entity_id + \u0001 + type_id + \u0001 + QEF + \u0001 + QAEF + \u0001 + MET + \u0001 + MAET + \u0001 + LET + \u0001 + LAET
	...
	//ShiftAddXorSignedStringMap surfaceForm2Position = new ShiftAddXorSignedStringMap( surfaceForms.iterator(), new MWHCFunction<CharSequence>(
	//	surfaceForms, TransformationStrategies.utf16() ) );

	//ShiftAddXorSignedStringMap surfaceForm2Position = new ShiftAddXorSignedStringMap( surfaceForms.iterator(), new MWHCFunction.Builder<CharSequence>()
	...
	//MWHCFunction<CharSequence> surfaceForm2Position = new MWHCFunction.Builder<CharSequence>().keys( surfaceForms ).transform( TransformationStrategies.utf16() ).signed( 5 ).build();
	...
	QuasiSuccinctEntityHash quasiSuccinctEntityHash = new QuasiSuccinctEntityHash( surfaceForm2Position, cutPointsArray, valuesA, new EliasFanoLongBigList( entityValues ),
    ...
    /**
     * Checks if the map has been created correctly, by decompressing the data structure and checking it against the original input file
     * @param jsapResult
