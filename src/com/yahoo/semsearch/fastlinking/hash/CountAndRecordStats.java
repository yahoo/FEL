 ...
 * probabilities later on when ranking.
 * 
 * @author roi
 * 
 */
public class CountAndRecordStats implements Serializable {
    ...
    private CountAndRecordStats( long SQAF, long SQAT, long SQAC, long SLAF, long SLAT, long SQEF, long SQAEF, long SMET, long SMAET, long SLET, long SLAET,
	    long entities, long phrases, long entityPhrasePairs ) {
	...
	return new CountAndRecordStats( SQAF, SQAT, SQAC, SLAF, SLAT, SQEF, SQAEF, SMET, SMAET, SLET, SLAET, quasiHash.entityNames.size(),
		quasiHash.hash.size(), entityPhrasePairs );
    }
