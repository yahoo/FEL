...
public class CentroidEntityContext extends EntityContext {
    ...
    public CentroidEntityContext( String unigramF, String entityF, AbstractEntityHash hash ) throws ClassNotFoundException, IOException {
	Word2VecCompress vec = (Word2VecCompress) BinIO.loadObject( entityF );
	scorer = new CentroidEntityScorer( (Word2VecCompress) BinIO.loadObject( unigramF ), vec );
	this.hash = (QuasiSuccinctEntityHash) hash; //TODO --- 
	init( vec );
    }
